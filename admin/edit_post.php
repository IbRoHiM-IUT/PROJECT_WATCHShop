...
<?php
  ...
  if (isset($_POST['update'])) {
    ...
    if($title=='' || $content=='' || $cat=='' || $author=='' || $tags==''){
      ...
      unlink("../images/".$single['image']); // deleting image in database
    }
  }
?>
...
<html lang="en">
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          ...
          <a class="blog-nav-item" href="add_post.php">Add New Category</a>
  ...
  <label>Post Content:</label>
   <textarea class="form-control" rows="3" name="content" placeholder="Enter a content"><?php echo $single['content']; ?></textarea>
   </div>
